...
<body class="<?php print $body_classes; ?>">
  <div id="page" class="container-16 clear-block">
    ...
    <?php if (($primary_links || $secondary_links || $navbar) && 1==0 ): ?>
    ...
    <div id="site-header" class="clear-block">
	    ...
	    <a href="/contact" title="Contact Us" target="_blank" id ="social-contact">&nbsp;</A>
	    <A href="http://twitter.com/AvalancheGuys" target="_blank" title="Follow us on Twitter" id="social-twitter">&nbsp;</A>&nbsp;<A href="http://www.facebook.com/pages/Bozeman-MT/Friends-of-the-Gallatin-National-Forest-Avalanche-Center/173768210029?ref=ts" target="_blank" title="Facebook with the Friends!" id="social-facebook"></A> <A href="/podcast/feed"><img src = "/sites/all/themes/gnfac-theme/images/Feed-32x32.png" id = "social-rss"></A>
	    </div>
	    <?php if ($search_box): ?>
          <div id="search-box" class="grid-6 prefix-10"><?php print $search_box; ?> 
          </div>
        <?php endif; ?>
